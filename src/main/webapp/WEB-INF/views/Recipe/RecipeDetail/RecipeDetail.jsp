...
<link href="RecipeDetail.css?ver=1.0" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.3/css/all.css" integrity="sha384-SZXxX4whJ79/gErwcOYf+zWLeJdY/qpuqC4cAa9rOGUstPomtqpuNWT9wdPEn2fk" crossorigin="anonymous">
</head>
<body>
	<div class="popUp_box">
		<div class="recipe_name"><span>소세지빵 레시피</span><img class="bread_cap" src="../../../images/빵모자.png"></div>
		<div class="popUp_contentBox">
			...
			<div class="popUp_contentBox_righttBox">
				...
				<div class="popUp_contentBox_righttBox_title"><span>바삭바삭 치즈스틱 :)</span></div>
				<div class="popUp_contentBox_righttBox_cookTime"><i class="far fa-clock"></i><span>조리시간</span><span style="black">20분</span></div>
				...
				<div class="popUp_contentBox_righttBox_list">재료 리스트 항목 영역</div>
