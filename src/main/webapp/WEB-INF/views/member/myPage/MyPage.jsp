...
<body>
	...
	<div class="myPage_content_title">
		<div class="myPage_content_title_myRecipe ">마이 레시피<span class="title_common_number">${ rList.size() }</span></div>
		<div class="myPage_content_title_scrap "><a href="SCList.me">스크랩<span class="title_common_number">55</span></a></div>
