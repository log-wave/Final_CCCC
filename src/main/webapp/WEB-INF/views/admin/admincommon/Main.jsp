...
<body>
	<div class="admin_menu">
		<div class="menu_label" align="center">
			...
			<label class="admin_menu_nav" id="adminRecipe.ad">레시피 관리</label><br><br><br>
			<label class="admin_menu_nav" id="adminMaterial.ad">재료 관리</label><br><br><br>
			<label class="admin_menu_nav" id="adminSpeciality.ad">지역특산물 관리</label><br><br><br>
