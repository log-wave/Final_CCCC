...
<link rel="stylesheet" href="<c:url value='/resources/css//style.css/admin/admin_qaDetail.css?ver=1.0'/>">
</head>
<body>
	<div class="qaDetail_main" align="center">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="window.close();">목록으로</button>
	...
	<button id="button2">답변 삭제</button>
	<script>
		$(function(){
			getAnswerList();
		});
